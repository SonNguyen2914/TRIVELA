# V9.3 — Model & Calibration

`mls-2026-v0`, as deployed for the `mls-shadow-v1.4` baseline. Every
...
- **In-sample tuning.** Every sweep above selects a parameter on the same
  162 matches. Finding 2 in [`AUDIT-FINDINGS.md`](AUDIT-FINDINGS.md) shows
